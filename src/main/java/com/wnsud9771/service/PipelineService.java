...
import com.wnsud9771.dto.filter.filtering.CampaignIdFormatIdFilterIdDTO;
...
//							campaignIdFormatIdDTO.setFormatId(addformatTopicdto.getFormatId());
							...
							createFormatTopicService.createTopicAndSendLog(campaignIddto.getCampaingId(), addformatTopicdto.getFormatId());
...
//									eventPublisher.publishEvent(new FilterCreatedEvent(this, campaignIdFormatIdFilterIdDTO)); //포맷 CampaignIdFormatIdFilterIdDTO
									...
									createFilterTopicService.createTopicAndSendLog(campaignIddto.getCampaingId(), addformatTopicdto.getFormatId(), filterTopicdto.getFilterId());
